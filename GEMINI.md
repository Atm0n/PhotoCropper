...
- **Multi-Language Localization**: Uses standard Avalonia `ResourceDictionary` files for i18n. Supports auto-detection and manual overrides for English, Spanish, and Catalan.

## Conventions

- **Testing Standards**: Maintain 100% pass rate in `PhotoCropper.Tests`. Tests must cover new processing logic and edge cases for `Mat` manipulation.

## TODO / Roadmap

- [x] **Feature**: Manual 90° rotation support in GUI.
- [x] **Feature**: Allow discarding individual cropped photos from the UI.
- [x] **Feature**: **Multi-Language Support** (EN, ES, CA).
- [x] **Improvement**: **Precision Zoom & Pan** for manual cropping.
